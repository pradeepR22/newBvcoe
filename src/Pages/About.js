...
function About() {
  return (
    <div className="m-10">
      <h1 className="text-white font-extrabold text-7xl text-center m-10 underline decoration-amber-500 select-none hover:text-amber-500 hover:decoration-white">About Us</h1>
      <div className="bg-gray-50 text-center p-10 flex flex-col items-center select-none gap-10 mb-10 rounded-2xl">
        <h1 className="font-bold text-2xl ">GREAT TASTE, DELIVERED SAFE</h1>
        <p className="text-lg">
      ...
      <div className="text-center bg-gray-50 flex flex-col gap-10 select-none p-10  rounded-2xl">
        <h1 className="text-2xl font-bold">CELEBRATIONS MADE EASY</h1>
        <p className="text-lg">
